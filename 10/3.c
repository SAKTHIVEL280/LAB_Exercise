...
int main() {
    Graph g;
    g.n = 6; // Number of vertices
    g.e = 7; // Number of edges

    g.edges[0] = (Edge){0, 1, 7};
    g.edges[1] = (Edge){0, 2, 8};
    g.edges[2] = (Edge){1, 2, 6};
    g.edges[3] = (Edge){1, 3, 9};
    g.edges[4] = (Edge){2, 3, 10};
    g.edges[5] = (Edge){3, 4, 4};
    g.edges[6] = (Edge){4, 5, 2};
    kruskalMST(&g);
    return 0;
}
